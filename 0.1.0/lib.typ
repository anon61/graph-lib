// --- Internal Imports ---
#import "modules/visuals.typ": diagram, node, edge, canvas, adj-graph, path-graph, cycle-graph, automaton
...
#import "modules/worksheet.typ": worksheet-title, question // <--- ADDED THIS
...
#let project(title: "", authors: (), body) = {
  ...
  // If using the worksheet module, we often skip the standard title 
  // because worksheet-title handles it. But we keep this for generic docs.
  // We can make it conditional, but for now, we leave it simple.
